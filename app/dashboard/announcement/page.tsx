...
export default function UserDashboard() {
  ...
  const navItems = [
    ...
    { label: t.menu.announcement, icon: <img src="/announcement.png" alt="" className="max-w-[18px] max-h-[18px]" />, badge: "12+", active: true, link: "/dashboard/announcement" },
    { label: t.menu.article, icon: <img src="/article.png" alt="" className="max-w-[18px] max-h-[18px]" />, link: "/dashboard/articles" },
